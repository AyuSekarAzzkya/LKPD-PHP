    ...
    <body>
        ...
        <?php
        if (isset ($_POST ['kirim'])) { //memeriksa variabel kirim sudah ada nilai
            $jamDatang = $_POST ['datang']; // mengambil var datang dan pulang
            $jamPulang = $_POST ['pulang'];
            $totalJam = $jamPulang - $jamDatang ;

            $jamNormal = 8; //mengeset nilai default 8
            $kompensasi = 0;
            ...
            echo "<br>";
            echo "Jumlah Kompensasi: Rp. ".number_format($kompensasi, 0, ',', '.'); // untuk mengelompokan nilai memakan koma
        }
